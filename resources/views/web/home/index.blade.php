    ...
    <div id="page_wrapper" class="bg-white">
                        ...
                        <div id="watch-slider" style="width:1420px; height:740px; margin:0 auto; margin-bottom: 0px;">
                            ...
                            <div class="ls-slide"
                                ...
                                <p style="font-weight:600; text-align:right; width:400px; font-size:45px; line-height:60px; top:120px; right:20px; white-space:normal; font-family: 'IRANyekan' !important"
                                    ...
                                    data-ls="offsetyin:40; delayin:250; easingin:easeOutQuint; filterin:blur(10px); offsetyout:-200; durationout:400; parallax:false;">ساعت مچی مردانه مدل دیزل Diesel
                                </p>

                                <p style="font-weight:400; text-align:right; width:380px; font-size:17px; line-height:30px; top:270px; right:20px; white-space:normal;" class="ls-l text-general"
                                    data-ls="offsetyin:40; delayin:450; easingin:easeOutQuint; offsetyout:-200; durationout:400; parallax:false;">کالاهای لوکس مانند ساعت نباید گران باشند و به همین
                                    دلیل است که ما تصمیم به تاسیس شرکت خود گرفته ایم.</p>
                                ...
                                <p style="font-weight:400; text-align:right; width:300px; font-size:16px; line-height:30px; top:150px; right:87.5%; white-space:normal;"
                                    class="ls-l higlight-font text-secondary" data-ls="offsetyin:40; delayin:700; easingin:easeOutQuint; offsetyout:-250; durationout:400; parallax:false;">با هر خرید
                                    10% مبلغ خود را هدیه بگیرید!</p>
                                ...
                                <div style="font-weight:400; text-align:right; width:300px; font-size:17px; line-height:30px; top:190px; right:87.5%; white-space:normal;" dir="rtl"
                                    class="ls-l higlight-font text-secondary" data-ls="offsetyin:40; delayin:900; easingin:easeOutQuint; offsetyout:-250; durationout:400; parallax:false;"><ins
                                        class="text-primary">1640000 تومان</ins> <del>1148000 تومان</del></div>

                                <a class="ls-l ls-hide-phone" href="shop-grid-full.html" target="_self"
                                    data-ls="offsetyin:150; durationin:700; delayin:1100; easingin:easeOutQuint; rotatexin:20; scalexin:1.4; offsetyout:600; durationout:400; hover:true; hoveropacity:1; hoverbgcolor:#e74c3c ; parallaxlevel:0;">
                                    <p style="cursor:pointer; font-weight: 400; padding-top:12px; padding-bottom:12px; font-size:13px; top:250px; right:93%; background:#141926; color:#ffffff; padding-right:25px; padding-left:25px; line-height:25px;"
                                        class="text-uppercase">مشاهده</p>
                                </a>
                            </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12">
                        <div class="products product-style-1">
                            <div class="row  row-cols-xl-3 row-cols-lg-2 row-cols-md-3 row-cols-sm-2 row-cols-1 e-title-hover-primary e-hover-image-zoom e-info-center">

                                <div class="col border-1">
                                    <div class="product type-product">
                                        <div class="product-wrapper">
                                            <div class="product-image">
                                                <a href="single-shop.html" class="woocommerce-LoopProduct-link"><img src="assets/images/products/squire-268.png" alt="Product Image"></a>
        ...
        <div class="full-row pb-0">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="banner-four" style="background: url(assets/images/background/15.png) no-repeat center / 100%; margin: 40px 0;">
                            <div class="row justify-content-center">
                                <div class="col-xl-5 col-lg-6 offset-md-1 col-md-6 sm-mb-50">
                                    <div class="banner-four-content position-relative y-center watch-banner">
                                        <h2 class="font-400 f-iransans"><a href="#" class="text-white"> مشاهده برند picto </h2>
                                ...
                                <div class="col-xl-4 col-lg-4 offset-lg-1 col-md-5 col-sm-8">
                                    <div style="margin: -40px 0;" class="banner-four d-table ml-auto position-relative md-ml-50">
                                        <img src="assets/images/banner/96.png" alt="Add Product">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="four-carousel owl-carousel dot-disable nav-arrow-middle-show e-title-hover-primary e-hover-image-zoom e-info-center" dir="ltr">
                                ...
                                <div class="item border-1">
                                    <div class="product type-product">
                                        <div class="product-wrapper">
                                            <div class="product-image">
                                                <a href="single-shop.html" class="woocommerce-LoopProduct-link"><img src="assets/images/products/squire-271.png" alt="Product Image"></a>
                                                <div class="hover-area">
                                                    <div class="cart-button">
                                                        <a href="#" class="button add_to_cart_button" data-bs-toggle="tooltip" data-bs-placement="right" title=""
                                                            data-bs-original-title="افزودن به سبد خرید" aria-label="Add to Cart">افزودن به سبد خرید</a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="owl-carousel partner-slider" dir="ltr">
                            ...
                            <div class="item">
                                <img src="assets/images/partner/18.png" alt="" />
                            </div>
